...
import 'package:my_project/Praktek/HistoryScreen.dart';
import 'package:my_project/Praktek/ItemsScreen.dart';
import 'package:my_project/Praktek/List_dialog.dart';
import 'package:my_project/Praktek/Provider/myProvider.dart';
import 'package:my_project/Praktek/model/ShoppingList.dart';
import 'package:my_project/Praktek/DB/DBhelper.dart';
import 'package:my_project/Praktek/HistoryProvider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 182, 247, 5),
        actions: <Widget>[
          IconButton(
